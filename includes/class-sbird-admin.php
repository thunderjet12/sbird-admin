<?php
use Sbird_Admin\Includes\i18n;
use Sbird_Admin\Includes\Dependency_Loader;
use Sbird_Admin\Core\Registry\Controller as Controller_Registry;
use Sbird_Admin\Core\Registry\Controller as Model_Registry;
use Sbird_Admin\App\Models\Settings;

require_once plugin_dir_path( __FILE__ ) . '/class-dependency-loader.php';


if ( ! class_exists( 'Sbird_Admin' ) ) {
	 ...
	 */
	class Sbird_Admin extends  Dependency_Loader {
		 ...
		 * @since    1.0.0
		 * @access   private
		 * @var      Sbird_Admin    $instance    Instance of this class.
		 */
		...
		private function set_locale() {
			...
			$plugin_i18n->set_domain( Sbird_Admin::PLUGIN_ID );
