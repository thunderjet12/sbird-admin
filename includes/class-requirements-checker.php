...
if ( ! class_exists( 'Requirements_Checker' ) ) {
	...
	class Requirements_Checker {
		 ...
		 *
		 * @param string $sbird_admin Name of the plugin.
		 * @param string $plugin_slug Slug of the plugin.
		 * @return boolean
		 * @since 1.0.0
		 */
		private function is_plugin_active( $sbird_admin, $plugin_slug ) {
			...
			$this->add_error_notice(
				$sbird_admin . ' is a required plugin.',
				$sbird_admin . ' needs to be installed & activated.'
			);
		 ...
		 *
		 * @param string $sbird_admin Plugin Name.
		 * @param string $plugin_slug Plugin Slug.
		 * @param string $min_plugin_version Minimum version required of the plugin.
		 * @return boolean
		 * @since 1.0.0
		 */
		private function is_required_plugin_version_active( $sbird_admin, $plugin_slug, $min_plugin_version ) {
			...
			$this->add_error_notice(
				"{$sbird_admin} {$min_plugin_version}+ is required.",
				"{$sbird_admin} {$installed_plugin_version} is installed."
			);
