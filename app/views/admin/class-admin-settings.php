...
if ( ! class_exists( __NAMESPACE__ . '\\' . 'Admin_Settings' ) ) {
	 ...
	 * @since      1.0.0
	 * @package    Sbird_Admin
	 * @subpackage Sbird_Admin/views/admin
	 */
	class Admin_Settings extends View {
		/**
		 * Prints Settings Page.
		 *
		 * @param  array $args Arguments passed by `markup_settings_page` method from `Sbird_Admin\App\Controllers\Admin\Admin_Settings` controller.
		 * @return void
		 * @since 1.0.0
		 */
		 ...
		 *
		 * @param  array $args Arguments passed by `markup_section_headers` method from  `Sbird_Admin\App\Controllers\Admin\Admin_Settings` controller.
		 * @return void
		 * @since 1.0.0
		 */
		 ...
		 * Prints text field
		 *
		 * @param  array $args Arguments passed by `markup_fields` method from `Sbird_Admin\App\Controllers\Admin\Admin_Settings` controller.
		 * @return void
		 * @since 1.0.0
		 */
