Sbird_Admin\Core\Registry\Controller
===============
...
### get_key
    ...
    string Sbird_Admin\Core\Registry\Controller::get_key(string $controller_class_name, string $model_class_name, string $view_class_name)
...
### set
    ...
    void Sbird_Admin\Core\Registry\Controller::set(string $key, mixed $value)
...
### get
    ...
    mixed Sbird_Admin\Core\Registry\Controller::get(string $key)
...
### get_all_objects
    ...
    array Sbird_Admin\Core\Registry\Controller::get_all_objects()
