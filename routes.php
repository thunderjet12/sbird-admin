...
use Sbird_Admin\Core\Route_Type as Route_Type;
...
|		>with_controller( 'Admin_Settings' ) // Resolved by Router to 'Sbird_Admin\App\Controllers\Admin\Admin_Settings'.
|		->with_model( 'Admin_Settings' ) // Resolved by Router to 'Sbird_Admin\App\Models\Admin\Admin_Settings'.
|		->with_view( 'Admin_Settings' ); // Resolved by Router to 'Sbird_Admin\App\Views\Admin\Admin_Settings'.
|-------------------------------------------------------------------------------------------
*/
...
|	$router
|		->register_route_of_type( ROUTE_TYPE::ADMIN )
|		->with_controller( 'Sbird_Admin\App\Controllers\Admin\Admin_Settings' )
|		->with_model( 'Sbird_Admin\App\Models\Admin\Admin_Settings' )
|		->with_view( 'Sbird_Admin\App\Views\Admin\Admin_Settings' );
|-------------------------------------------------------------------------------------------
*/
...
|	$router
|		->register_route_of_type( ROUTE_TYPE::ADMIN )
|		->with_just_model('sbird_admin_Model_Admin_Settings');
|-------------------------------------------------------------------------------------------
*/
...
$router
	->register_route_of_type( ROUTE_TYPE::ADMIN )
	->with_controller( 'Admin_Settings@register_hook_callbacks' ) // Resolved by Router to 'Sbird_Admin\App\Controllers\Admin\Admin_Settings'.
	->with_model( 'Admin_Settings' ) // Resolved by Router to 'Sbird_Admin\App\Models\Admin\Admin_Settings'.
	->with_view( 'Admin_Settings' ); // Resolved by Router to 'Sbird_Admin\App\Views\Admin\Admin_Settings'.
